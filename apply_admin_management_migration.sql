-- Script para aplicar a migração do sistema de gestão de administrativas
...
-- Insert initial admin data (opcional - pode remover em produção)
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.admin_access_tokens TO authenticated;
