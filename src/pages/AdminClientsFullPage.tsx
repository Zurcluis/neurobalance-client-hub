      ...
      <div className="flex min-h-screen bg-muted/50">
        ...
        <main className={cn(
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Não tem permissão para ver os clientes.</p>
          </div>
        </main>
      </div>
    );
    ...
    <div className="flex min-h-screen bg-muted/50">
      ...
      <main className={cn(
        ...
        <div className={cn(
          ...
          {/* Renderizar a página completa de clientes no contexto administrativo */}
...
export default AdminClientsFullPage;