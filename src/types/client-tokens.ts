...
export const CLIENT_VALIDITY_PERIODS = {
...
export const generateClientAccessToken = (): string => {
    ...
    return `CLIENT_${randomPart}${timestampPart}`.toUpperCase();
};

export const calculateClientExpirationDate = (validityPeriod: keyof typeof CLIENT_VALIDITY_PERIODS): string => {
    const hours = CLIENT_VALIDITY_PERIODS[validityPeriod].hours;
